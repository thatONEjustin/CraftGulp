    ...
    constructor() {
       try {
            super({
              el: '#app',
                data: {
                    greeting: 'Modal loaded but still get intellisense error on the .vue import'
                }
            });
       } catch (error) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-5126377c", module.exports)
  }
}
...
var update = __webpack_require__(8)("4f76327b", content, false);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(3), __webpack_require__(11)))
...
var Modal_vue_1 = __webpack_require__(0);
// let greet = new Greeter('Testing browser sync'); 
var modal = new Modal_vue_1.Modal({
    el: '#app'
});
// alert(greet.say()); 
